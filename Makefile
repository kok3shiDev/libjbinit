...
all:
	...
	$(CC) $(DYLD_FLAGS) $(DEBUG_FLAGS) $(DEVFLAG) -Iinclude/ -I../../../include dyld_ramdisk.c printf.c dyld_utils.c ../../lz4dec/test/lz4dec_dyld.c ../../lz4dec/src/lz4dec.S -o build/com.apple.dyld
